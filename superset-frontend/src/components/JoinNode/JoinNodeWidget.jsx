...
import JoinNodeModal from './JoinNodeModal';
  ...
  generatePort = port => {
    const portCom = (
      <PortWidget engine={this.props.engine} port={port} key={port.getID()}>
        <div className="join-port" />
      </PortWidget>
    );
    const label = <div className="join-port-label" />;

    return (
      <div className="join-port-label-container">
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="join-port-container">
