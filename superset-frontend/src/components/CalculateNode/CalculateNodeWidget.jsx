...
import CalculateNodeModal from './CalculateNodeModal';
import './CalculateNodeStyle.less';

export class CalculateNodeWidget extends React.Component {
  ...
  generatePort = port => {
    const portCom = (
      <PortWidget engine={this.props.engine} port={port} key={port.getID()}>
        <div className="Calculate-port" />
      </PortWidget>
    );
    const label = <div className="Calculate-port-label" />;

    return (
      <div className="Calculate-port-label-container">
      ...
      >
        ...
        >
          <div className="Calculate-title">
            <div className="Calculate-title-name">
          ...
          <div className="Calculate-port-container">
