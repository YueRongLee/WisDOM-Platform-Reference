...
const plugins = [
  ...
  new webpack.DefinePlugin({
    ...
    'process.env.WISDOM_ENV': JSON.stringify(process.env.WISDOM_ENV),
    'process.env.CDP': JSON.stringify(process.env.CDP),
  }),
...
const config = {
  ...
  entry: {
    ...
    wisDOM: addPreamble('/src/wisDOM/index.jsx'),
    tablePermission: addPreamble('/src/TablePermission/index.jsx'),
    workspace: addPreamble('/src/workspace/index.jsx'),
    newworkspace: addPreamble('/src/dataflow/index.jsx'),
    groupManagement: addPreamble('/src/GroupManagement/index.jsx'),
    groupPermission: addPreamble('/src/GroupPermission/index.jsx'),
    showSavedQuery: [path.join(APP_DIR, '/src/showSavedQuery/index.jsx')],
    roleManagement: addPreamble('/src/RoleManagement/index.jsx'),
    datasetManagement: addPreamble('/src/DatasetManagement/index.jsx'),
    dataDomainManagement: addPreamble('/src/CategoryManagement/index.jsx'),
    powerbiTemplate: addPreamble('/src/PowerbiTemplate/index.jsx'),
    dataUsageStatistics: addPreamble('/src/DataUsageStatistics/index.jsx'),
    outputs: addPreamble('/src/Outputs/index.jsx'),
    dataRobotModelList: addPreamble('/src/DataRobotModelList/index.jsx'),
    releases: addPreamble('/src/Information/functionReleases/index.jsx'),
    sitemap: addPreamble('/src/Information/sitemap/index.jsx'),
    systemGuidebook: addPreamble('/src/Information/systemGuidebook/index.jsx'),
    dataSecurityPolicy: addPreamble(
      '/src/Information/dataSecurityPolicy/index.jsx',
    ),
    learningByFunctions: addPreamble(
      '/src/Information/learningByFunctions/index.jsx',
    ),
    learningByScenarios: addPreamble(
      '/src/Information/learningByScenarios/index.jsx',
    ),
    workshop: addPreamble('/src/Information/workshop/index.jsx'),
    userManagement: addPreamble('/src/UserManagement/index.jsx'),
    logout: addPreamble('/src/logout/index.jsx'),
  },
  output,
  stats: 'minimal',
  performance: {
  ...
  module: {
    ...
    rules: [
      ...
      },
      {
        ...
        ].concat(isDevMode ? ['eslint-loader'] : []),
      },
      {
        test: /\.jsx?$/,
        ...
        use: [babelLoader].concat(isDevMode ? ['eslint-loader'] : []),
      },
      {
        test: /\.css$/,
