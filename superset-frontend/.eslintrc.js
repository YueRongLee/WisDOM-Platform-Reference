  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        '@typescript-eslint/no-non-null-assertion': 0, // V1.0.1
      },
    },
  ],
  rules: {
    ...
    indent: 0,
    'jsx-a11y/anchor-is-valid': 0, // disabled temporarily
    // 'jsx-a11y/anchor-is-valid': 1, //V1.0.1
    'jsx-a11y/click-events-have-key-events': 0, // re-enable up for discussion
    'jsx-a11y/mouse-events-have-key-events': 0, // re-enable up for discussion
    'new-cap': 0,
    'no-bitwise': 0,
    ...
    'react/sort-comp': 1,
    // 'react/sort-comp': 0, // TODO: re-enable in separate PR //V1.0.1
    'prettier/prettier': 'error',
    'no-nested-ternary': 1,
  },
};
